...
('Habitación Principal', 'Habitación amplia con ventana exterior. Incluye cama doble, armario empotrado y escritorio. Excelente iluminación natural.', 'https://images.unsplash.com/photo-1540518614846-7eded433c457', 2, 'Primera planta', 'ESPACIO', 'DISPONIBLE', 1, 1, 1, NOW() - INTERVAL '120 days', NOW()),
('Habitación Pequeña', 'Habitación individual acogedora. Perfecta para estudiante. Incluye cama individual y escritorio.', 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85', 1, 'Segunda planta', 'ESPACIO', 'OCUPADO', 1, 1, 2, NOW() - INTERVAL '120 days', NOW()),
('Cocina Compartida', 'Cocina totalmente equipada con nevera, horno, microondas y lavavajillas. Amplia encimera para cocinar.', 'https://images.unsplash.com/photo-1556911220-bff31c812dba', 4, 'Planta baja', 'ESPACIO', 'DISPONIBLE', 1, 1, 3, NOW() - INTERVAL '120 days', NOW()),
('Baño Principal', 'Baño completo con ducha de hidromasaje. Incluye secador y espejo con iluminación LED.', 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14', 1, 'Primera planta', 'ESPACIO', 'DISPONIBLE', 1, 2, 4, NOW() - INTERVAL '115 days', NOW()),
...
('Habitación Suite', 'Suite con baño privado y balcón. Armario vestidor y zona de trabajo independiente.', 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af', 2, 'Tercera planta', 'ESPACIO', 'DISPONIBLE', 2, 4, 1, NOW() - INTERVAL '90 days', NOW()),
